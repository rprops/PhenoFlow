...
<b>_Warning: the HNA/LNA partition is only valid for data gathered on a BD C6 Accuri flow cytometer_
_For other flow cytometers the threshold (FL1-H = 20 000) should be adjusted accordingly_<\b>
```R
